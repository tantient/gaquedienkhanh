...
const CONTENT: Record<string, {
  ...
  vi: {
    ...
    heroSub: "Từ vùng quê Diên Khánh đến lòng phố biển Nha Trang — một hành trình của hương vị và tình yêu ẩm thực.",
    storyLabel: "Nguồn Gốc",
    storyTitle: "Sinh ra từ vùng đất Diên Khánh",
    story: [
      "Diên Khánh là một huyện bình yên nằm sâu trong lòng tỉnh Khánh Hòa, nơi những người dân quê vẫn giữ nguyên lối sống mộc mạc, chân chất. Chính từ mảnh đất này, chúng tôi đã học được rằng bữa ăn ngon nhất không cần sơn hào hải vị — chỉ cần sự tận tâm và nguyên liệu sạch.",
      "Ý tưởng mở quán bắt đầu từ những bữa cơm gia đình bên hiên nhà, nơi mùi lá é quyện cùng hơi nóng của nồi lẩu bốc lên trong gió chiều. Đó là hương vị mà chúng tôi muốn chia sẻ với tất cả mọi người.",
      "Khi chuyển ra Nha Trang, chúng tôi mang theo không chỉ công thức nấu ăn mà còn cả hồn quê — sự chân thật, mộc mạc và ấm áp của người Diên Khánh.",
    ],
    chickenLabel: "Gà Ta Diên Khánh",
    chickenTitle: "Gà ta 'đi bộ' — Bí quyết của hương vị",
    chicken: [
      "Điểm khác biệt lớn nhất của Gà Quê Diên Khánh chính là chất lượng nguyên liệu. Chúng tôi chỉ sử dụng gà ta thuần chủng — những con gà được thả tự do trên đồi đất đỏ Diên Khánh, tự nhiên kiếm ăn từ lúc mặt trời mọc đến khi tà dương.",
      "Gà thả đồi có cơ bắp săn chắc hơn do vận động nhiều, thịt có độ ngọt tự nhiên không thể tìm thấy ở gà công nghiệp. Da vàng óng, thịt thớ mịn — đây là tiêu chuẩn mà chúng tôi không bao giờ thỏa hiệp.",
      "Mỗi tuần, chúng tôi chỉ nhận gà từ những hộ nông dân quen thuộc ở Diên Khánh đã gắn bó với chúng tôi nhiều năm. Đây là cam kết về chất lượng mà chúng tôi giữ vững từ ngày đầu mở quán.",
    ],
    spaceLabel: "Không Gian Lá Chanh",
    spaceTitle: "Nơi thiên nhiên và ẩm thực hoà quyện",
    space: [
      "Không gian Lá Chanh được lấy cảm hứng từ những khu vườn xanh mát của vùng quê Diên Khánh — nơi những tán cây chanh xanh rì che bóng mát cho những bữa cơm chiều.",
      "Chúng tôi sử dụng vật liệu tự nhiên: gỗ mộc, tre nứa, và lá cây tươi để tạo nên không gian vừa gần gũi vừa thanh mát. Ánh sáng tự nhiên và gió trời là những người bạn đồng hành không thể thiếu.",
      "Ngồi tại Gà Quê Diên Khánh, bạn không chỉ thưởng thức bữa ăn — bạn đang sống lại khoảnh khắc bình yên của làng quê Việt Nam, dù đang giữa lòng thành phố.",
    ],
    valuesLabel: "Giá Trị Cốt Lõi",
    values: [
      { title: "Nguyên Liệu Sạch", desc: "Gà ta thuần chủng thả đồi, lá é hái sáng, rau củ không hóa chất." },
      { title: "Nấu Tại Chỗ", desc: "Mỗi món đều được chuẩn bị và nấu tươi mỗi ngày, không sử dụng thức ăn đông lạnh." },
      { title: "Giá Thật — Hương Vị Thật", desc: "Chúng tôi không dùng hương liệu nhân tạo. Mọi hương vị đều đến từ nguyên liệu tự nhiên." },
      { title: "Phục Vụ Tận Tâm", desc: "Mỗi vị khách đều được đón tiếp như người thân trong gia đình." },
    ],
  },
  en: {
    breadcrumb: "About Us",
